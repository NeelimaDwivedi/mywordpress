		...
		<div class="mwb-m-go-pro-banner">
			<div class="mwb-m-inner-container">
				<div class="mwb-m-name-wrapper" id="mwb-m-page-header">
					<h3><?php esc_html_e( 'Welcome To MakeWebBetter', 'metaglobal' ); ?></h4>
					</div>
				</div>
			</div>
			<div class="mwb-m-inner-logo-container">
				<div class="mwb-m-main-logo">
					<img src="<?php echo esc_url( METAGLOBAL_DIR_URL . 'admin/images/logo.png' ); ?>">
					<h2><?php esc_html_e( 'We make the customer experience better', 'metaglobal' ); ?></h2>
					<h3><?php esc_html_e( 'Being best at something feels great. Every Business desires a smooth buyer’s journey, WE ARE BEST AT IT.', 'metaglobal' ); ?></h3>
				</div>
						...
						<table class="mwb-m-table">
							<thead>
								<tr class="mwb-plugins-head-row">
									<th><?php esc_html_e( 'Plugin Name', 'metaglobal' ); ?></th>
									<th><?php esc_html_e( 'Active Status', 'metaglobal' ); ?></th>
								</tr>
							</thead>
							<tbody>
									...
									<?php foreach ( $mwb_m_all_plugins as $m_plugin_key => $m_plugin_value ) { ?>
										<tr class="mwb-plugins-row">
											...
											<?php if ( isset( $m_plugin_value['active'] ) && '1' != $m_plugin_value['active'] ) { ?>
												<td><?php esc_html_e( 'NO', 'metaglobal' ); ?></td>
											<?php } else { ?>
												<td><?php esc_html_e( 'YES', 'metaglobal' ); ?></td>
											<?php } ?>
										</tr>
									<?php } ?>
								<?php } ?>
