		...
		<div class="mwb-s-go-pro-banner">
			<div class="mwb-s-inner-container">
				<div class="mwb-s-name-wrapper" id="mwb-s-page-header">
					<h3><?php esc_html_e( 'Welcome To MakeWebBetter', 'secondplugin' ); ?></h4>
					</div>
				</div>
			</div>
			<div class="mwb-s-inner-logo-container">
				<div class="mwb-s-main-logo">
					<img src="<?php echo esc_url( SECONDPLUGIN_DIR_URL . 'admin/images/logo.png' ); ?>">
					<h2><?php esc_html_e( 'We make the customer experience better', 'secondplugin' ); ?></h2>
					<h3><?php esc_html_e( 'Being best at something feels great. Every Business desires a smooth buyer’s journey, WE ARE BEST AT IT.', 'secondplugin' ); ?></h3>
				</div>
						...
						<table class="mwb-s-table">
							<thead>
								<tr class="mwb-plugins-head-row">
									<th><?php esc_html_e( 'Plugin Name', 'secondplugin' ); ?></th>
									<th><?php esc_html_e( 'Active Status', 'secondplugin' ); ?></th>
								</tr>
							</thead>
							<tbody>
									...
									<?php foreach ( $mwb_s_all_plugins as $s_plugin_key => $s_plugin_value ) { ?>
										<tr class="mwb-plugins-row">
											...
											<?php if ( isset( $s_plugin_value['active'] ) && '1' != $s_plugin_value['active'] ) { ?>
												<td><?php esc_html_e( 'NO', 'secondplugin' ); ?></td>
											<?php } else { ?>
												<td><?php esc_html_e( 'YES', 'secondplugin' ); ?></td>
											<?php } ?>
										</tr>
									<?php } ?>
								<?php } ?>
