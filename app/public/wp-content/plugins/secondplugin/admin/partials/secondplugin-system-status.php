...
<div class="mwb-s-table-wrap">
	<div class="mwb-s-table-inner-container">
		<table class="mwb-s-table" id="mwb-s-wp">
			<thead>
				<tr>
					<th><?php esc_html_e( 'WP Variables', 'secondplugin' ); ?></th>
					<th><?php esc_html_e( 'WP Values', 'secondplugin' ); ?></th>
				</tr>
			</thead>
			<tbody>
	...
	<div class="mwb-s-table-inner-container">
		<table class="mwb-s-table" id="mwb-s-php">
			<thead>
				<tr>
					<th><?php esc_html_e( 'Sysytem Variables', 'secondplugin' ); ?></th>
					<th><?php esc_html_e( 'System Values', 'secondplugin' ); ?></th>
				</tr>
			</thead>
			<tbody>
